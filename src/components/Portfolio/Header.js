  ...
  return (
    <div className="bg-gray-900 text-gray-100 min-h-screen font-sans overflow-x-hidden">
      ...
      >
        ...
        >
          <ul className="max-w-screen-xl mx-auto px-4 flex flex-col space-y-4">
            {[
              "home",
              "about",
              "skills",
      ...
      <section
        id="home"
        className="min-h-screen flex items-center pt-0 relative overflow-hidden px-4 md:px-6"
        ref={(ref) => registerSection("home", ref)}
      >
        <div className="max-w-screen-xl mx-auto">
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-5xl font-bold leading-tight mb-6 animate-slide-up delay-300">
              Hi, I'm <span className="text-blue-600">Surya Prakash Polu</span>
            </h1>
            <h2 className="text-2xl md:text-3xl text-gray-300 mb-6 flex animate-slide-up delay-500">
              I'm a <span className="text-orange-500 ml-2">{typedText}</span>
            </h2>
            <p className="text-lg md:text-xl text-gray-400 mb-8 animate-slide-up delay-700 max-w-2xl">
            ...
            <div className="flex flex-wrap gap-4 mb-8 animate-slide-up delay-1000">
              <a
                href="#contact"
                className="px-6 md:px-8 py-3 bg-blue-600 hover:bg-blue-700 rounded text-white font-medium transition-all hover:-translate-y-1 hover:shadow-lg"
              >
                Hire Me
              </a>
              <a
                href="#projects"
                className="px-6 md:px-8 py-3 border-2 border-blue-600 text-white rounded font-medium transition-all hover:-translate-y-1 hover:bg-blue-600 hover:shadow-lg"
              >
                View Projects
              </a>
            </div>
